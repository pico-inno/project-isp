<mijnui:sidebar x-data variant="double">
    ...
    <mijnui:sidebar.double>
        <img src="{{ asset('storage/logo/logo.png') }}" alt="Logo" class="w-full mx-auto px-2 my-4" />
        <mijnui:button
    ...
    <mijnui:sidebar.double.content mijnui-sidebar-child="dashboard" title="Getting Started">
    ...
    <mijnui:sidebar.double.content mijnui-sidebar-child="user" title="User Management">
        <mijnui:list class="flex h-full w-full flex-col items-center gap-2 px-4 py-4">
            <mijnui:list.item href="#" :active="request()->routeIs('')" wire:navigate>Users List</mijnui:list.item>
        </mijnui:list>
    </mijnui:sidebar.double.content>
